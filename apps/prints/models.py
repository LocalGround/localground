...
from localground.apps.prints.managers import PrintManager, FormManager #, PrintPermissionsManager
from localground.apps.uploads.models import Snippet, Base
...
class Print(Base):
    ...
    '''def get_auth_users(self):
        from localground.apps.account.models import PrintUser
    ...
    def get_map_groups(self):
        from localground.apps.account.models import MapGroupPrint
