...
from localground.apps.registration import forms
from localground.apps.registration import signals
from localground.apps.registration.admin import RegistrationAdmin
from localground.apps.registration.backends import get_backend
from localground.apps.registration.backends.default import DefaultBackend
from localground.apps.registration.models import RegistrationProfile
...
class BackendRetrievalTests(TestCase):
    ...
    def test_get_backend(self):
        ...
        """
        self.failUnless(isinstance(get_backend('localground.apps.registration.backends.default.DefaultBackend'),
                                   DefaultBackend))
    ...
    def test_backend_attribute_error(self):
        ...
        """
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'localground.apps.registration.backends.default.NonexistentBackend')
