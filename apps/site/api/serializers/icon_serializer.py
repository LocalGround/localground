...
class IconSerializer(MediaGeometrySerializer):
    ...
    def process_file(self, file, owner):
        ...
        return {
            ...
            'file_name_large': icon_paths[1],
            'file_name_medium': icon_paths[2],
            'file_name_medium_sm': icon_paths[3],
            'file_name_small': icon_paths[4],
            'file_name_marker_lg': icon_paths[5],
            'file_name_marker_sm': icon_paths[6],
