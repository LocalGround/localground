...
class MapImageOverlayUpdateSerializer(AuditSerializerMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'url', 'geometry', 'file_path', 'file_name_orig', 'opacity', 'name')
        depth = 0
...
class MapImageOverlayCreateSerializer(MapImageOverlayUpdateSerializer):
    ...
    class Meta:
        model = models.ImageOpts
        read_only_fields = ('file_path', 'file_name_orig')
        fields = ('id', 'url', 'geometry', 'file_path', 'file_name_orig', 'media_file', 'opacity', 'name')
        depth = 0
    ...
    def create(self, validated_data):
        ...
        model_name_plural = models.MapImage.model_name_plural
        file_name_new = upload_helpers.save_file_to_disk(owner, model_name_plural, f, uuid=mapimage.uuid)
