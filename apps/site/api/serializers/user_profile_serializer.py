...
class UserProfileSerializer(
        UserProfileMixin, serializers.HyperlinkedModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        # manually update view_authority to point to ObjectAuthority
        # object not the string
        instance.default_view_authority = ObjectAuthority.objects.get(
            name=validated_data.get(
                'default_view_authority', instance.default_view_authority))
