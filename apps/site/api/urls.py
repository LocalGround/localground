...
urlpatterns += format_suffix_patterns(patterns('',
	...
	url(r'^presentations/(?P<pk>[0-9]+)/$', views.PresentationInstance.as_view(), name='presentation-detail'),
	url(r'^presentations/$', views.PresentationList.as_view(), name='presentation-list'),
	url(r'^views/(?P<pk>[0-9]+)/$', views.ViewInstance.as_view(), name='view-detail'),
	url(r'^views/$', views.ViewList.as_view(), name='view-list'),
