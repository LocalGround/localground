from localground.apps.site.models import PointMixin, BaseAudit, BaseGenericRelationMixin, ProjectMixin
...
class DynamicModelMixin(PointMixin, BaseGenericRelationMixin, BaseAudit):
