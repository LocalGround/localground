...
class WhereCondition(Field):
    
    def __init__(self, col_name, id=None, title=None, data_type=DataTypes.STRING,
                                    operator='=', conjunction='AND', val=None):
        
        super(WhereCondition, self).__init__(col_name, id=id, title=title,
                                data_type=DataTypes.STRING, operator=operator)
...
class OrderingCondition(Field):
    
    def __init__(self, col_name, id=None, title=None, data_type=DataTypes.STRING,
                                    direction='asc'):
        
        super(WhereCondition, self).__init__(col_name, id=id, title=title,
                                data_type=DataTypes.STRING, operator=None)
