from localground.apps.site.managers.groups import ProjectManager, FormManager, \
...
from localground.apps.site.managers.uploads import MapImageManager, \
    PhotoManager, AudioManager, VideoManager, RecordManager, StyledMapManager, IconManager
