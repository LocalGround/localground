    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basemap', models.ForeignKey(default=12, to='site.WMSOverlay')),
                ('last_updated_by', models.ForeignKey(related_name='site_styledmap_related', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AlterField(
            model_name='audio',
            name='description',
            field=models.TextField(null=True, verbose_name=b'caption', blank=True),
        ),
        migrations.AlterField(
            model_name='mapimage',
            name='description',
