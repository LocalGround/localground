    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='CCCCCC', max_length=6)),
                ('attributes', django.contrib.postgres.fields.hstore.HStoreField()),
                ('last_updated_by', models.ForeignKey(on_delete=models.CASCADE, related_name='site_markerwithattributes_related', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('project', models.ForeignKey(on_delete=models.CASCADE, related_name='markerwithattributes+', to='site.Project')),
            ],
            options={
                'ordering': ['id'],
                'verbose_name': 'marker',
