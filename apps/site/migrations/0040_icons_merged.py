    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(max_length=63, verbose_name='file type', choices=[(b'svg', b'svg'), (b'jpeg', b'jpeg'), (b'png', b'png')])),
                ...
                ('last_updated_by', models.ForeignKey(on_delete=models.CASCADE, related_name='site_icon_related', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('project', models.ForeignKey(on_delete=models.CASCADE, related_name='icon+', to='site.Project')),
            ],
            options={
                'ordering': ['id'],
                'verbose_name': 'icon',
        ...
        migrations.AlterField(
            model_name='icon',
            name='anchor_x',
            field=models.FloatField(help_text='Icon anchor point - x coordinate'),
        ),
        migrations.AlterField(
            model_name='icon',
            name='anchor_y',
            field=models.FloatField(help_text='Icon anchor point - y coordinate'),
        ),
        migrations.AlterField(
            model_name='icon',
            name='file_type',
            field=models.CharField(max_length=63, verbose_name='file type', choices=[(b'svg', b'svg'), (b'jpg', b'jpg'), (b'png', b'png')]),
        ),
        migrations.AddField(
            model_name='icon',
            name='size',
