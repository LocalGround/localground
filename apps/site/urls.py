...
urlpatterns = patterns('',
    ...
    (r'^project/(?P<project_id>[0-9]+)/$', MainView.as_view(template_name='pages/project_detail.html')),
    (r'^maps/(?P<map_slug>[\w-]+)/$', PublicView.as_view(template_name='pages/presentation.html')),
