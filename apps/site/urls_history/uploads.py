...
urlpatterns = patterns('localground.apps.site.views',
    ...
    (r'^update-photo/$', 'apiuploads.update_photo'),
    (r'^update-photo/embed/$', 'apiuploads.update_photo', {
        'embed': True,
        'base_template': 'base/iframe.html'
    }),
    (r'^update-audio/$', 'apiuploads.update_audio'),
    (r'^update-audio/embed/$', 'apiuploads.update_audio', {
        'embed': True,
        'base_template': 'base/iframe.html'
    }),
