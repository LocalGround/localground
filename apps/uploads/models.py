...
from localground.apps.uploads.managers import *
from localground.apps.helpers.models import BaseObject, PointObject
import os, stat
import base64       
...
process_map.delay('zmqv8rlv')
    ...
    def process(self):
        from localground.apps.uploads.image_processing.processor import Processor
