...
from localground.registration import forms
from localground.registration import signals
from localground.registration.admin import RegistrationAdmin
from localground.registration.backends import get_backend
from localground.registration.backends.default import DefaultBackend
from localground.registration.models import RegistrationProfile
...
class BackendRetrievalTests(TestCase):
    ...
    def test_get_backend(self):
        ...
        """
        self.failUnless(isinstance(get_backend('localground.registration.backends.default.DefaultBackend'),
                                   DefaultBackend))
    ...
    def test_backend_attribute_error(self):
        ...
        """
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'localground.registration.backends.default.NonexistentBackend')
