...
CUSTOM_MEDIA_PREFIX = '/site_media/'
...
MIDDLEWARE_CLASSES = (
    ...
    'localground.middleware.impersonate.ImpersonateMiddleware'
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'localground.context_processors.persistant_queries', #for our application-level context objects
)

ROOT_URLCONF = 'localground.urls'
...
INSTALLED_APPS = (
    ...
    'localground.prints',
    'localground.uploads',
    'localground.overlays',
    'localground.registration',     #taken from the django-registration module
    'tagging',                      #for tagging of blog posts in Django
    'django.contrib.admin',
    'localground.jobs'

)
TAGGING_AUTOCOMPLETE_JS_BASE_URL = '/site_media/scripts/jquery-autocomplete'
...
FONT_ROOT = '%s/site_media/css/fonts/' % FILE_ROOT
