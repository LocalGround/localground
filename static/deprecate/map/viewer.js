...
localground.viewer.prototype.initialize = function (opts) {
    ...
    this.presentation = new localground.presentation();
...
localground.viewer.prototype.doViewportUpdates = function () {
    for (var key in self.managers) {
        try {
            self.managers[key].doViewportUpdates();
        }
        catch (e) {
        }
    }
...
localground.viewer.prototype.toggleProjectData = function (groupID, groupType, is_checked, turn_on_everything) {
...
localground.viewer.prototype.getProjectData = function (groupID, groupType, is_checked, turn_on_everything, access_key) {
