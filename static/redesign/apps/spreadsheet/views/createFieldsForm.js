define([
    ...
    'use strict';
    var CreateFieldView = Marionette.CompositeView.extend({
        ...
        /*
        // TODO: Since we are adding only one field,
        // we need to simplify the majority of the code
        // and refactor the saveFormSettings
        // so that a field is added into the spreadsheet itself 
        */
        events: {
