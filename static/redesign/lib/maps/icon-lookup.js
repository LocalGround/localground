define([], function () {
    ...
    */
    var Icon = function (key) {
        var baseWidth = 15,
            ...
            lookup = {
                ...
                cross: {
                    ...
                    // Taken from: https://icomoon.io/app/#/select
                    viewBox: [-1, -1, 1051, 1052],
                    baseWidth: 1050,
                    baseHeight: 1050,
                    width: 20,
                    height: 20,
        ...
        this.getViewBox = function (icon) {
            return '-1 -1 ' + (icon.baseWidth + 1) + ' ' + (icon.baseHeight + 2);
        };
        ...
        this.setIcon = function (key) {
            ...
            icon.viewBox = icon.viewBox || this.getViewBox(icon);
            //console.log(icon);
            _.extend(this, icon);
