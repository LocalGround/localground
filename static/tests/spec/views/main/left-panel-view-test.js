...
define([
    ...
    rootDir + "apps/main/views/left/skin-view",
    rootDir + "apps/main/views/left/panel-styles-view",
    rootDir + "apps/main/router",
    rootDir + "models/layer",
    "tests/spec-helper1"
],
    function ($, Backbone, Marionette, LeftPanelView, MapTitleView, LayerListView, SkinView, PanelStylesView, Router, Layer) {
        'use strict';
        var lpv, fixture;
        ...
        describe("LeftPanelView initialization: ", function () {
            ...
            it("has correct regions", function() {
                ...
                expect(lpv.regions.skins).toEqual("#map_skin_region");
                expect(lpv.regions.styles).toEqual("#global_style_region");
            });
