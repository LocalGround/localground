...
from localground.lib.models import PointObject, ObjectTypes, ReturnCodes
...
def update_photo(request, identity=None, embed=False,
                 template_name='forms/photo.html', base_template='twitter/base.html'):
    from localground.uploads.models import Photo
    from localground.uploads.forms import PhotoForm
...
def update_audio(request, identity=None, embed=False,
                 template_name='forms/audio.html', base_template='twitter/base.html'):
    from localground.uploads.models import Audio
    from localground.uploads.forms import AudioForm
...
def get_scan_photo_options(request, identity=None):
    from localground.uploads.models import ImageOpts
    r = request.GET or request.POST
...
def set_scan_photo(request, identity=None):
    from localground.uploads.models import Scan, ImageOpts
    r = request.GET or request.POST
